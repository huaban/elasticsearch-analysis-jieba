...
**2.4.4**
```sh
./bin/plugin install https://github.com/windoze/elasticsearch-analysis-jieba/releases/download/v2.4.4/elasticsearch-analysis-jieba-2.4.4-bin.zip
```
